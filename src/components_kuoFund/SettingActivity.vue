<script setup>
    ...
    function change_image_to_base64(event){
        console.log("change_image_to_base64");
...
<template>
    ...
    <div class="w-10/10 flex flex-row gap-2 place-items-center">
        <div class="w-5/10 flex flex-col">
            <label class="label">
                地點:
        ...
        <div class="w-5/10 flex flex-col">
            <label class="label">
                圖檔:
                <input type="file" id="fileInput" @change="change_image_to_base64" />
            </label>
        </div>
    </div>
    <div class="w-10/10 flex flex-row gap-2 place-items-center">
        <div class="w-5/10 flex flex-col">
         ...
         <button class="btn btn-neutral w-5/10" @click="new_manual_page">
            NEW
        </button>
    </div>
