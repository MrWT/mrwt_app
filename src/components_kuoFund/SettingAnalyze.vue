...
<div class="relative h-10/10 w-10/10 flex flex-col">
    <div class="w-10/10 h-1/10 flex flex-none justify-end">
        <button class="btn btn-ghost" @click="analyze_survey">
    ...
    <div class="w-10/10 h-9/10 overflow-y-auto">
