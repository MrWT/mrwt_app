...
<template>
    ...
    <div class="navbar bg-base-100 shadow-sm z-[51] sticky top-0">
        ...
        <div class="navbar-end gap-2">
            ...
            <!-- userInfo -->
            <a v-if="signinStatus === true" class="cursor-pointer tooltip tooltip-bottom" :data-tip="userInfo.languages.user_setting" @click="openUserInfoModal">
    ...
    <div class="p-4 h-11/12">
        <!-- Login -->
        <Login v-if="appSetting.contentComponent === 'login'" @signin="signin" />
